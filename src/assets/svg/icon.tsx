...
export const IconContribution: SvgComponent = (props) => {
    return (
        <MuiSvgIcon {...props} viewBox="0 0 24 24" fill="none">
            <path d="M16 18C15.38 18 14.7913 17.9093 14.234 17.728C13.6767 17.5467 13.164 17.2893 12.696 16.956C13.372 16.2227 13.9057 15.4363 14.297 14.597C14.689 13.7577 14.885 12.892 14.885 12C14.885 11.108 14.689 10.2423 14.297 9.403C13.9057 8.56367 13.3723 7.77733 12.697 7.044C13.1643 6.71067 13.6767 6.45333 14.234 6.272C14.7907 6.09067 15.3793 6 16 6C17.668 6 19.085 6.583 20.251 7.749C21.417 8.91567 22 10.3327 22 12C22 13.668 21.417 15.085 20.251 16.251C19.0843 17.417 17.6673 18 16 18ZM12 16.442C11.378 15.8987 10.8893 15.2453 10.534 14.482C10.178 13.72 10 12.8927 10 12C10 11.108 10.178 10.2803 10.534 9.517C10.8893 8.75433 11.378 8.101 12 7.557C12.622 8.101 13.1107 8.75433 13.466 9.517C13.822 10.2803 14 11.108 14 12C14 12.892 13.822 13.7197 13.466 14.483C13.1107 15.2457 12.622 15.899 12 16.443M8 18C6.332 18 4.915 17.417 3.749 16.251C2.583 15.0843 2 13.6673 2 12C2 10.332 2.583 8.915 3.749 7.749C4.91567 6.583 6.33267 6 8 6C8.62 6 9.20867 6.09067 9.766 6.272C10.3233 6.45333 10.836 6.71067 11.304 7.044C10.628 7.77733 10.0943 8.56367 9.703 9.403C9.311 10.2423 9.115 11.108 9.115 12C9.115 12.996 9.30567 13.9187 9.687 14.768C10.069 15.6173 10.594 16.357 11.262 16.987C10.7973 17.3163 10.2887 17.5673 9.736 17.74C9.18267 17.9133 8.604 18 8 18Z" />
        </MuiSvgIcon>
    );
};
...
export const IconFolder: SvgComponent = (props) => {
    return (
        <MuiSvgIcon {...props} viewBox="0 0 16 16" fill="none">
            <path d="M2.66668 13.3327C2.30001 13.3327 1.98612 13.2021 1.72501 12.941C1.4639 12.6799 1.33334 12.366 1.33334 11.9993V3.99935C1.33334 3.63268 1.4639 3.31879 1.72501 3.05768C1.98612 2.79657 2.30001 2.66602 2.66668 2.66602H6.66668L8.00001 3.99935H13.3333C13.7 3.99935 14.0139 4.1299 14.275 4.39102C14.5361 4.65213 14.6667 4.96602 14.6667 5.33268V11.9993C14.6667 12.366 14.5361 12.6799 14.275 12.941C14.0139 13.2021 13.7 13.3327 13.3333 13.3327H2.66668Z" />
        </MuiSvgIcon>
    );
};
